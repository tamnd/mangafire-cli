...
Most of these come down to network reality or how mangafire serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mangafire rate-limits like any public site. mangafire already paces
...
Where a surface is gated, mangafire reads a cookie or token you supply
...
`mangafire`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mangafire actually did
